    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @auth
                    @can('create', App\Models\Vacancy::class)
                        <a class="flex flex-col items-center justify-center mr-2 text-sm font-extrabold text-white bg-indigo-600 rounded-full w-7 h-7 hover:bg-indigo-800" href="{{ route('notifications') }}">
            ...
            <div class="pt-2 pb-3 space-y-1">
                ...
                <x-responsive-nav-link :href="route('notifications')" :active="request()->routeIs('notifications')">
                    <div class="flex items-center gap-2">
                        <span class="flex flex-col items-center justify-center mr-2 text-sm font-extrabold text-white bg-indigo-600 rounded-full w-7 h-7 hover:bg-indigo-800"">
                            {{ Auth::user()->unreadNotifications->count() }}
                        </span>
